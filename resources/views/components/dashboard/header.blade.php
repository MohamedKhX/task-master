<header class="sticky z-10 top-0 flex w-full bg-white drop-shadow-1">
    <div class="flex flex-grow items-center justify-between lg:justify-end py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        <div class="flex items-center gap-3 2xsm:gap-7">
            <livewire:notifications :employee="$employee"/>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center gap-4" href="#" @click.prevent="dropdownOpen = ! dropdownOpen">
                    <span class="hidden text-right lg:block">
                        ...
                        <div>
                            ...
                            @endrole
                            @hasallroles('teamLeader|admin')
                                <span>&</span>
                            @endhasallroles
                            @role('admin')
                                <span class="text-danger font-bol">
                                    Admin
                                </span>
                            @endrole
                        </div>
                    ...
                    <span class="h-12 w-12 rounded-full">
                        <img src="{{ asset($employee->avatar_path) }}" alt="User" />
                    </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    <ul class="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
                        <li>
                            <a wire:navigate href="{{ route('employee.show', $employee) }}"
