<ul class="flex items-center gap-2 2xsm:gap-4">
    ...
    >
        <a class="relative cursor-pointer flex h-8.5 w-8.5 items-center justify-center rounded-full border-[0.5px] border-stroke bg-gray hover:text-primary dark:border-strokedark dark:bg-meta-4 dark:text-white"
        ...
        <div x-show="dropdownOpen"
            ...
            <ul class="flex h-auto flex-col overflow-y-auto">
                ...
                @empty
                    <span class="text-center mt-5">You don't have any notifications yet!</span>
                @endforelse
            </ul>
        </div>
        <!-- Dropdown End -->
