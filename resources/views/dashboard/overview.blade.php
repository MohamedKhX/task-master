<x-dashboard-layout>
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <!--         <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                   &lt;!&ndash; ====== Chart One Start &ndash;&gt;
                   <include src="./partials/chart-01.html" />
                   &lt;!&ndash; ====== Chart One End &ndash;&gt;

                   &lt;!&ndash; ====== Chart Two Start &ndash;&gt;
                   <include src="./partials/chart-02.html" />
                   &lt;!&ndash; ====== Chart Two End &ndash;&gt;

                   &lt;!&ndash; ====== Chart Three Start &ndash;&gt;
                   <include src="./partials/chart-03.html" />
                   &lt;!&ndash; ====== Chart Three End &ndash;&gt;

                   &lt;!&ndash; ====== Map One Start &ndash;&gt;
                   <include src="./partials/map-01.html" />
                   &lt;!&ndash; ====== Map One End &ndash;&gt;

                   &lt;!&ndash; ====== Table One Start &ndash;&gt;
                   <div class="col-span-12 xl:col-span-8">
                     <include src="./partials/table-01.html" />
                   </div>
                   &lt;!&ndash; ====== Table One End &ndash;&gt;

                   &lt;!&ndash; ====== Chat Card Start &ndash;&gt;
                   <div
