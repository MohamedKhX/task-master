...
class PowerGridTheme extends Tailwind
{
    ...
    {
        return Theme::table('min-w-full dark:bg-slate-800', 'overflow: visible !important')
            ->div('overflow-visible my-3 rounded relative shadow dark:bg-pg-primary-700 dark:border-pg-primary-600',
            ...
            ->th('w-0 font-semibold px-2 pr-4 py-3 text-left text-xs font-semibold text-pg-primary-700 tracking-wider whitespace-nowrap dark:text-pg-primary-300')
            ->tbody('text-pg-primary-800')
            ->trBody('border-pg-primary-100 dark:border-pg-primary-600 hover:bg-pg-primary-50 dark:bg-pg-primary-800 dark:hover:bg-pg-primary-700')
